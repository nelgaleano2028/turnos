		...
		<div class="row-fluid">
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="turnoshe" width="100%" style="color:rgb(41,76,139) !important;">
				<thead style="background-color:rgb(41,76,139) !important;">
			        <tr>
					<th style="color:#2b4c88; font-weight: bold" width="9%" scope="col">Codigo</th>
					<th style="color:#2b4c88; font-weight: bold" width="9%" scope="col">Empleado</th>
					<th style="color:#2b4c88; font-weight: bold" width="9%" scope="col">Valor</th>
				...
				<tbody>
					<?php for($i=0; $i<count($datos); $i++){ ?>
						<tr> 
							...
							<td align="center"><?php echo $datos[$i]['valor']; ?></td>

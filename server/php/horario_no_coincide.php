...
$sql1="SELECT color_mas FROM colores where posicion='".$dia."' and mes='".$mes."'  and anio='".$anio."' and cod_epl='".$cod_epl."'";
...
//ME DEVUELVE LAS HORAS, HORA INICIO Y HORA FIN DEL TURNO REAL
	...
	$mensaje .= "<td  scope='col' width='10px' style='font-weight: bold;'>Turno</td>";
	$mensaje .= "<td  scope='col' width='10px'>".$turno." - ".$hor_ini_real." - ".$hor_fin_real."</td>";
	$mensaje .= "</tr>";	
	$mensaje .= "</thead>";
	$mensaje .= "</table>"; 
	$mensaje .= "<input type='hidden' id='color_mas' value='".$color_mas."' />"; 

...
$datos=$obj->get_inter_tur($_SESSION['cod_epl']);
				...
				<tbody>
					<?php for($i=0; $i<count($datos); $i++){ ?>
						<tr> 
                                                    ...
                                                    <td align="center">
                                                            <a href="#"  onClick="aceptar_solicitud_inter('<?php echo $datos[$i]['id']; ?>','<?php echo $datos[$i]['Fecha']; ?>','<?php echo $datos[$i]['cod_epl_cambio']; ?>','<?php echo $datos[$i]['cod_epl_actual']; ?>','<?php echo $datos[$i]['Turno_Actual']; ?>','<?php echo $datos[$i]['Turno_a_Cambiar']; ?>','<?php echo $_SESSION['cod_epl']; ?>');" >
                                                                    <img src="../../img/success.gif" title="Aprobar" alt="Aprobar" />
                                                            </a></td>
                                                            <td align="center">
                                                            <a href="#"  onClick="rechazar_solicitud_inter('<?php echo $datos[$i]['id']; ?>','<?php echo $datos[$i]['cod_epl_actual']; ?>','<?php echo $datos[$i]['cod_epl_cambio']; ?>','<?php echo $_SESSION['cod_epl']; ?>','<?php echo $datos[$i]['Turno_Actual']; ?>','<?php echo $datos[$i]['Turno_a_Cambiar']; ?>','<?php echo $datos[$i]['Fecha']; ?>');" >
...
<script src="../../js/novedades.js?param=[0,1,2]" type="text/javascript"></script>
</body>
</html>
...
$datos=$obj->editar_ciclo($_POST['cod_old'],$_POST['codigo_turno'],$_POST['obser'],$_POST['td1'],$_POST['td2'],$_POST['td3'],$_POST['td4'],$_POST['td5'],$_POST['td6'],$_POST['td7'],$_POST['horas'],$_POST['cod_cc2'],$_SESSION['cod_epl']);

	if($datos===1){
		echo '<span class="mensajes_success">Se Editaron los datos correctamente</span>';
	}else if($datos===2){
		echo '<span class="mensajes_error">No se ha podido editar los en la base de datos intente mas tarde</span>';
	}else if($datos===4){
